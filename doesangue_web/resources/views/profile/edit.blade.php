          ...
          <form method="post" action="{{ route('profileAdmin.update') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row"> {{-- edit telefone form --}}
                  <label class="col-sm-2 col-form-label">{{ __('Telefone') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="user_telefone" id="input-telefone" type="telefone" placeholder="{{ __('Telefone') }}" value="{{ old('telefone', auth()->user()->user_telefone) }}" required />
                      @if ($errors->has('email'))
          ...
          <form method="post" action="{{ route('profileAdmin.password') }}" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-password-confirmation">{{ __('Confirme nova senha') }}</label>
                  <div class="col-sm-7">
